...
```Python
import cv2 // OpenCV library for computer vision and image/video processing tasks. It provides tools for capturing video, manipulating frames, and saving video files.
import numpy as np
import time
