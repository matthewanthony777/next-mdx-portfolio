...
- **Real-time Frame Processing**: Detect motion and color changes through your muggle webcam.
...
If this doesnt work, and assuming you are using macOS install pythong using homebrew at the terminal prompt
